...
export default function GestionarPermisosPage() {
  ...
  async function loadTiendas() {
    try {
      ...
      // silently ignore, but show a toast
  ...
  async function handleCreate() {
    ...
    try {
      ...
      // show full error payload when possible to diagnose 422
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-6">
        <h1 className="text-xl font-semibold mb-4">Gestión de permisos - Usuario {params.id}</h1>
